...
from .model import GlossaryTerm, GlossaryTermUpdate
...
def create_term(db: Session, term_data: GlossaryTermUpdate) -> GlossaryTerm:
...
def update_term(db: Session, db_term: GlossaryTerm, term_data: GlossaryTermUpdate) -> GlossaryTerm:
